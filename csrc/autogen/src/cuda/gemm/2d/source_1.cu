...
void na2d_nn_cuda_gemm_double_128x128x16_64x64x16_8x8x4_3_ks43_align1(
  ...
  int dilation,
  float scale) {
  using GConfig = natten::gemm::detail::GemmConfig2D<128, 128, 16, 64, 64, 16, 8, 8, 4, 3, 11, 2, 21>;
  using AConfig = natten::gemm::detail::AlignmentConfig<1, 1, 1>;
  using DConfig = natten::gemm::detail::DTypeConfig<natten::float64>;
  using Kernel = NeighborhoodNeighborhood2D<GConfig, AConfig, DConfig>;
  Kernel kernel;
...
void na2d_nn_cuda_gemm_double_128x128x16_64x64x16_8x8x4_3_ks45_align1(
  ...
  int dilation,
  float scale) {
  using GConfig = natten::gemm::detail::GemmConfig2D<128, 128, 16, 64, 64, 16, 8, 8, 4, 3, 11, 2, 22>;
  using AConfig = natten::gemm::detail::AlignmentConfig<1, 1, 1>;
  using DConfig = natten::gemm::detail::DTypeConfig<natten::float64>;
  using Kernel = NeighborhoodNeighborhood2D<GConfig, AConfig, DConfig>;
  Kernel kernel;
...
void na2d_nn_cuda_gemm_double_128x128x16_64x64x16_8x8x4_3_ks47_align1(
  ...
  int dilation,
  float scale) {
  using GConfig = natten::gemm::detail::GemmConfig2D<128, 128, 16, 64, 64, 16, 8, 8, 4, 3, 11, 2, 23>;
  using AConfig = natten::gemm::detail::AlignmentConfig<1, 1, 1>;
  using DConfig = natten::gemm::detail::DTypeConfig<natten::float64>;
  using Kernel = NeighborhoodNeighborhood2D<GConfig, AConfig, DConfig>;
  Kernel kernel;
...
void na2d_nn_cuda_gemm_double_128x128x16_64x64x16_8x8x4_3_ks49_align1(
  ...
  int dilation,
  float scale) {
  using GConfig = natten::gemm::detail::GemmConfig2D<128, 128, 16, 64, 64, 16, 8, 8, 4, 3, 11, 2, 24>;
  using AConfig = natten::gemm::detail::AlignmentConfig<1, 1, 1>;
  using DConfig = natten::gemm::detail::DTypeConfig<natten::float64>;
  using Kernel = NeighborhoodNeighborhood2D<GConfig, AConfig, DConfig>;
  Kernel kernel;
...
void na2d_nn_cuda_gemm_double_128x128x16_64x64x16_8x8x4_3_ks51_align1(
  ...
  int dilation,
  float scale) {
  using GConfig = natten::gemm::detail::GemmConfig2D<128, 128, 16, 64, 64, 16, 8, 8, 4, 3, 11, 2, 25>;
  using AConfig = natten::gemm::detail::AlignmentConfig<1, 1, 1>;
  using DConfig = natten::gemm::detail::DTypeConfig<natten::float64>;
  using Kernel = NeighborhoodNeighborhood2D<GConfig, AConfig, DConfig>;
  Kernel kernel;
...
void na2d_nn_cuda_gemm_double_128x128x16_64x64x16_8x8x4_3_ks53_align1(
  ...
  int dilation,
  float scale) {
  using GConfig = natten::gemm::detail::GemmConfig2D<128, 128, 16, 64, 64, 16, 8, 8, 4, 3, 11, 2, 26>;
  using AConfig = natten::gemm::detail::AlignmentConfig<1, 1, 1>;
  using DConfig = natten::gemm::detail::DTypeConfig<natten::float64>;
  using Kernel = NeighborhoodNeighborhood2D<GConfig, AConfig, DConfig>;
  Kernel kernel;
...
void na2d_nn_cuda_gemm_double_128x128x16_64x64x16_8x8x4_3_ks55_align1(
  ...
  int dilation,
  float scale) {
  using GConfig = natten::gemm::detail::GemmConfig2D<128, 128, 16, 64, 64, 16, 8, 8, 4, 3, 11, 2, 27>;
  using AConfig = natten::gemm::detail::AlignmentConfig<1, 1, 1>;
  using DConfig = natten::gemm::detail::DTypeConfig<natten::float64>;
  using Kernel = NeighborhoodNeighborhood2D<GConfig, AConfig, DConfig>;
  Kernel kernel;
...
void na2d_nn_cuda_gemm_double_128x128x16_64x64x16_8x8x4_3_ks57_align1(
  ...
  int dilation,
  float scale) {
  using GConfig = natten::gemm::detail::GemmConfig2D<128, 128, 16, 64, 64, 16, 8, 8, 4, 3, 11, 2, 28>;
  using AConfig = natten::gemm::detail::AlignmentConfig<1, 1, 1>;
  using DConfig = natten::gemm::detail::DTypeConfig<natten::float64>;
  using Kernel = NeighborhoodNeighborhood2D<GConfig, AConfig, DConfig>;
  Kernel kernel;
...
void na2d_nn_cuda_gemm_double_128x128x16_64x64x16_8x8x4_3_ks59_align1(
  ...
  int dilation,
  float scale) {
  using GConfig = natten::gemm::detail::GemmConfig2D<128, 128, 16, 64, 64, 16, 8, 8, 4, 3, 11, 2, 29>;
  using AConfig = natten::gemm::detail::AlignmentConfig<1, 1, 1>;
  using DConfig = natten::gemm::detail::DTypeConfig<natten::float64>;
  using Kernel = NeighborhoodNeighborhood2D<GConfig, AConfig, DConfig>;
  Kernel kernel;
...
void na2d_nn_cuda_gemm_double_128x128x16_64x64x16_8x8x4_3_ks61_align1(
  ...
  int dilation,
  float scale) {
  using GConfig = natten::gemm::detail::GemmConfig2D<128, 128, 16, 64, 64, 16, 8, 8, 4, 3, 11, 2, 30>;
  using AConfig = natten::gemm::detail::AlignmentConfig<1, 1, 1>;
  using DConfig = natten::gemm::detail::DTypeConfig<natten::float64>;
  using Kernel = NeighborhoodNeighborhood2D<GConfig, AConfig, DConfig>;
  Kernel kernel;
...
void na2d_nn_cuda_gemm_double_128x128x16_64x64x16_8x8x4_3_ks63_align1(
  ...
  int dilation,
  float scale) {
  using GConfig = natten::gemm::detail::GemmConfig2D<128, 128, 16, 64, 64, 16, 8, 8, 4, 3, 11, 2, 31>;
  using AConfig = natten::gemm::detail::AlignmentConfig<1, 1, 1>;
  using DConfig = natten::gemm::detail::DTypeConfig<natten::float64>;
  using Kernel = NeighborhoodNeighborhood2D<GConfig, AConfig, DConfig>;
  Kernel kernel;
