...
void hopper_fna3d_float16_64x128x64_Q4x4x4_KV4x4x8_causal1x1x0(
  ...
  using Kernel = natten::cuda::fna_hopper::KernelForward<
    cutlass::half_t, Causal, QTileShape, KVTileShape, GemmShape, natten::cuda::fna_hopper::HopperFnaKernelType::NonPersistent>;
...
void hopper_fna3d_float16_128x128x128_coop_Q4x4x8_KV4x4x8_causal0x0x0(
  ...
  using Kernel = natten::cuda::fna_hopper::KernelForward<
    cutlass::half_t, Causal, QTileShape, KVTileShape, GemmShape, natten::cuda::fna_hopper::HopperFnaKernelType::WSCooperative>;
...
void hopper_fna3d_float16_128x128x128_pp_Q4x4x8_KV4x4x8_causal0x0x0(
  ...
  using GemmShape = cute::tuple<cute::Int<128>, cute::Int<128>, cute::Int<128>>;
  using Kernel = natten::cuda::fna_hopper::KernelForward<
    cutlass::half_t, Causal, QTileShape, KVTileShape, GemmShape, natten::cuda::fna_hopper::HopperFnaKernelType::WSPingpong>;
