...
template <class TileShape_MNK_PV_, class ClusterShape_, class Element_, class ArchTag_,
          int NumEpilogueThreads_, bool PackGQA_, bool FP8PermuteCol=false>
struct CollectiveEpilogueFwd {
    ...
    static constexpr bool Use_TMA_O = ArchTag::kMinComputeCapability >= 90 && !PackGQA;
    ...
    store(Params const& params,
        ...
        if constexpr (Use_TMA_O) {
            ...
            // } else {
            //     Tensor mOpartial = make_tensor(make_gmem_ptr(params.ptr_O_partial + offset_o * get<0>(params.stride_O_partial)), params.shape_O_packed, params.stride_O_partial_packed)(_, _, bidh, bidb, split_idx);
