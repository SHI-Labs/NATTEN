...
template <class NADim>
struct Qkv_params: public NA_params<NADim> {
...
template <class NADim>
struct Flash_fna_fwd_params : public Qkv_params<NADim> {
    using index_t = int64_t;
...
template <class NADim>
struct Flash_fna_bwd_params : public Flash_fna_fwd_params<NADim> {
    using index_t = int64_t;
...
// void run_mha_fwd_(Flash_fna_fwd_params &params, cudaStream_t stream);
// void prepare_varlen_num_blocks(Flash_fna_fwd_params &params, cudaStream_t stream, bool packgqa, int blockM, int blockN, bool enable_pdl);
// template <int Arch, typename T, int kHeadDim, bool Has_softcap>
// void run_mha_bwd_(Flash_fna_bwd_params &params, cudaStream_t stream);
// template <typename T, typename Tpartial, int kBlockK>
// void run_mha_fwd_combine_(Flash_fna_fwd_params &params, cudaStream_t stream, bool enable_pdl);
