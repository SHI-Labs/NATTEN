...
template<bool PackGQA=false, int kBlock=128>
...
public:
    ...
    to_underlying_arguments(TileSchedulerArguments const& args) {
        return {args.num_blocks, args.num_head, args.num_batch, 1,
...
//             flash_fna::named_barrier_arrive(NumThreads, cutlass::arch::ReservedNamedBarriers::StreamkBarrier0 /*id*/);  // TileCountSmemEmpty
//         }
//     }
// 
//     CUTLASS_DEVICE
...
//             flash_fna::named_barrier_sync(NumThreads, cutlass::arch::ReservedNamedBarriers::StreamkBarrier0 /*id*/);  // TileCountSmemEmpty
//             if (threadIdx.x % NumProducerThreads == 0) {
//                 *tile_count_smem = current_work.tile_idx;
//             }
//             flash_fna::named_barrier_arrive(NumThreads, cutlass::arch::ReservedNamedBarriers::StreamkBarrier1 /*id*/);  // TileCountSmemFull
//             return {new_tile_idx};
//         } else {
//             flash_fna::named_barrier_sync(NumThreads, cutlass::arch::ReservedNamedBarriers::StreamkBarrier1 /*id*/);  // TileCountSmemFull
