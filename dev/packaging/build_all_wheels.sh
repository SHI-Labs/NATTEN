...
if [[ -n "$1" ]] && [[ -n "$2" ]]; then
  ...
  build_one cu116 1.12.1
  build_one cu113 1.12.1
  build_one cu102 1.12.1

  build_one cu116 1.12
  build_one cu113 1.12
  build_one cu102 1.12

  build_one cu115 1.11
  build_one cu113 1.11
  build_one cu102 1.11

  build_one cu113 1.10.1
  build_one cu111 1.10.1
  build_one cu102 1.10.1
