...
from natten.functional import NATTEN1DAVFunction, NATTEN1DQKRPBFunction
    ...
    for kernel_size in kernel_sizes:
        for dim in dims:
            for num_heads in heads:
                ...
                assert forward_mse < tol, f"FAIL: Forward MSE ({forward_mse}) was above the specified tolerance (tol) for heads={heads}, dim={dim}, kernel_size={kernel_size}."
                ...
                for name, n1w in nat1.named_modules():
                    ...
                    for name2, n2w in nat2.named_modules():
                        ...
                        assert mse < tol, f"FAIL: {name} gradient MSE ({mse}) was above the specified tolerance ({tol}) for heads={heads}, dim={dim}, kernel_size={kernel_size}."
