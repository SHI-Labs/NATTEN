...
def _priv_test_gradcheck_natten2dqk(
    ...
    assert gradcheck(
            ...
            rtol=rtol,
            nondet_tol=ndtol,
            fast_mode=fast_mode), f"Gradcheck failed for `NATTEN2D` with {dtype} on {device}, {md} MODE."
...
def _priv_test_gradcheck_natten2dqkrpb(
    ...
    assert gradcheck(
            ...
            rtol=rtol, 
            nondet_tol=ndtol, 
            fast_mode=fast_mode), f"Gradcheck failed for `NATTEN2D-QKRPB` with {dtype} on {device}, {md} MODE."
...
def _priv_test_gradcheck_natten2dav(
    ...
    assert gradcheck(
            ...
            rtol=rtol, 
            nondet_tol=ndtol, 
            fast_mode=fast_mode), f"Gradcheck failed for `NATTEN2D-AV` with {dtype} on {device}, {md} MODE."


def _priv_test_allclose_cpu_cuda(batch_size, height, width, 
...
class NA2DTest(unittest.TestCase):
    def test_natten2dqk_gradcheck_cpu_slow(self):
        ...
        _priv_test_gradcheck_natten2dqk(b, h, li, lj, d, k, di, torch.float64, 'cpu',
    ...
    def test_natten2dqk_gradcheck_cuda_slow(self):
        ...
        b, h, li, lj, d, k, di = 1, 1, 14, 14, 4, 7, 2
        _priv_test_gradcheck_natten2dqk(b, h, li, lj, d, k, di, torch.float64, 'cuda',
    ...
    def test_natten2dqkrpb_gradcheck_cpu_slow(self):
        b, h, li, lj, d, k, di = 1, 1, 14, 14, 4, 7, 2
        _priv_test_gradcheck_natten2dqkrpb(b, h, li, lj, d, k, di, torch.float64, 'cpu',
                                     1e-6, 1e-5, 1e-3, 0, False)
    ...
    def test_natten2dav_gradcheck_cpu_slow(self):
        b, h, li, lj, d, k, di = 1, 1, 14, 14, 4, 7, 2
        _priv_test_gradcheck_natten2dav(b, h, li, lj, d, k, di, torch.float64, 'cpu',
                                     1e-6, 1e-5, 1e-3, 0, False)
